...
## echos has been implemented manually for debugging purposes
...
scripts_dir=/mnt/flab/kirsten/IQ_Connect/fcon_1000_scripts
...
anat_name=anatomical_scan
## resting-state scan you want to use (no extension)
rest_name=functional_scan
...
## - TR
batch_list=${scripts_dir}/batch_list_Rockland_only.txt
